...
`https://github.com/MicrosoftLearning/PL-300-Microsoft-Power-BI-Data-Analyst/raw/Main/Allfiles/Labs/05-modify-filter-context/05-modify-filter-context.zip`

Extract the file to the **C:\Users\Student\Downloads\05-modify-filter-context** folder.
...
1. Add a measure to the `Sales` table, based on the following expression:
    ...
    > _**Note**: For your convenience, all DAX definitions in this lab can be copied from the **C:\Users\Student\Downloads\05-modify-filter-context\Snippets.txt** file._
